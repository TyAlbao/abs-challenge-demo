...
st.markdown(
    "ℹ️ **Tip:**\n\n"
    "• Use **strike** if you're on offense (batting team) - you want to challenge strikes that should've been called balls.  \n"
    "• Use **ball** if you're on defense (pitching team) - you want to challenge balls that should've been called strikes."
)
...
if "incorrect_call_prob" in st.session_state:
    ...
    team_diff = st.number_input("Batting Team Score Differential", -10, 10, -1)
